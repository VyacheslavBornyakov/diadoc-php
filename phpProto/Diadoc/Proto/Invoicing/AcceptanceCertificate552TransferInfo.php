...
class AcceptanceCertificate552TransferInfo extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>optional string OperationInfo = 1;</code>
     */
    ...
    {
        return isset($this->OperationInfo) ? $this->OperationInfo : '';
    }

    public function hasOperationInfo()
    {
        return isset($this->OperationInfo);
    }

    public function clearOperationInfo()
    {
        unset($this->OperationInfo);
    }
