...
{
    /**
     * Generated from protobuf field <code>optional .Diadoc.Api.Proto.Registration.RegistrationStatus RegistrationStatus = 1;</code>
     */
    ...
    {
        return isset($this->RegistrationStatus) ? $this->RegistrationStatus : 0;
    }

    public function hasRegistrationStatus()
    {
        return isset($this->RegistrationStatus);
    }

    public function clearRegistrationStatus()
    {
